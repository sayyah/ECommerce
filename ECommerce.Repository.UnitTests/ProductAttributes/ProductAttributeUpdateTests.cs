...
namespace ECommerce.Repository.UnitTests.ProductAttributes
{
    public class ProductAttributeUpdateTests : ProductAttributeBaseTest
    {
        ...
        [Fact]
        public async Task UpdateAsync_UpdateTitel_ReturnsChangedEntity()
        {
            //Arrange
            int id = 1;
            ...
            //Act
            await _productAttributeRepository.UpdateAsync(expectedProductAttribute, CancellationToken);
            ProductAttribute actualProductAttribute = DbContext.ProductAttributes.Where(c => c.Id == id).ToList().First();
        ...
        [Fact]
        public async Task UpdateRangeAsync_UpdateEntities_ReturnsChangedEntities()
        {
            //Arrange
            List<ProductAttribute> productAttributes =
            [
            ...
            //Act
            await _productAttributeRepository.UpdateRangeAsync(expectedProductAttributes,CancellationToken);
            var actualProductAttributes = DbContext.ProductAttributes.ToList();
