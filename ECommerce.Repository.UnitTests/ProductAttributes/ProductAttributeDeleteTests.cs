...
namespace ECommerce.Repository.UnitTests.ProductAttributes
{
    public class ProductAttributeDeleteTests : ProductAttributeBaseTest
    {
        ...
        public async Task DeleteAsync_DeleteEntity_ReturnNull()
        {
            ...
            //Act
            await _productAttributeRepository.DeleteAsync(expectedProductAttribute, CancellationToken);
        ...
        [Fact]
        public async Task DeleteRangeAsync_DeleteEntity_ReturnZero()
        {
            //Arrange
            int expectedCount = 0;
            List<ProductAttribute> productAttributes =
            ...
            //Act
            await _productAttributeRepository.DeleteRangeAsync(productAttributes, CancellationToken);
            int actualCount = DbContext.ProductAttributes.Count();
