...
namespace ECommerce.Repository.UnitTests.ProductAttributeGroups
{
    public class ProductAttributeGroupOthereTests : BaseTests
    {
        ...
        [Fact]
        public async Task GetAllAsync_CountAllEntities_ReturnsAllEntities()
        {
            //Arrange
            int expectedCount = 3;
            ...
            //Act
            var actualProductAttributeGroup = await _productAttributeGroupRepository.GetAllAsync(CancellationToken);
