...
namespace ECommerce.Repository.UnitTests.ProductAttributeValues
{
    public class ProductAttributeValueUpdateTests : ProductAttributeValueBaseTest
    {
        ...
        [Fact]
        public async Task UpdateAsync_UpdateValue_ReturnsChangedEntity()
        {
            //Arrange
            int id = 1;
            ...
            //Act
            await _productAttributeValueRepository.UpdateAsync(expectedProductAttributeValue, CancellationToken);
        ...
        [Fact]
        public async Task UpdateRangeAsync_UpdateValue_ReturnsChangedEntities()
        {
            //Arrange
            List<ProductAttributeValue> productAttributeValues =
             [
            ...
            //Act
            await _productAttributeValueRepository.UpdateRangeAsync(expectedProductAttributeValue, CancellationToken);
            var actualProductAttributeValue = DbContext.ProductAttributeValues.ToList();
