...
namespace ECommerce.Repository.UnitTests.ProductAttributeValues
{
    public class ProductAttributeValueDeleteTests : ProductAttributeValueBaseTest
    {
        ...
        [Fact]
        public async Task DeleteRangeAsync_DeleteEntity_ReturnZeroCount()
        {
            //Arrange
            int expectedCount = 0;
            List<ProductAttributeValue> productAttributeValues =
            ...
            //Act
            await _productAttributeValueRepository.DeleteRangeAsync(productAttributeValues,CancellationToken);
