...
namespace ECommerce.Repository.UnitTests.ProductAttributeValues
{
    public class ProductAttributeValueAddTests : ProductAttributeValueBaseTest
    {
        ...
        [Fact]
        public void AddRange_AddIistOfEntity_SameCountEntities()
        {
            //Arrange
            int expectedCount = 3;
        ...
        [Fact]
        public async void AddRangeAsync_AddIistOfEntity_SameCountEntities()
        {
            //Arrange
            int expectedCount = 3;
            List<ProductAttributeValue> productAttributeValues =
            ...
            //Act
            await _productAttributeValueRepository.AddRangeAsync(productAttributeValues, CancellationToken);
            int actualProductAttributeValueCount = DbContext.ProductAttributeValues.Count();
