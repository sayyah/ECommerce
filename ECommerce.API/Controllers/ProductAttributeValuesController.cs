...
public class ProductAttributeValuesController(IUnitOfWork unitOfWork,
    ...
    : ControllerBase
{
    private readonly IProductAttributeValueRepository _productAttributeValueRepository = unitOfWork.GetRepository<IProductAttributeValueRepository, ProductAttributeValue>();
