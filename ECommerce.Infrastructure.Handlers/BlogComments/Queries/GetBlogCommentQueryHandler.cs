...
{
    public class GetBlogCommentQueryHandler(IUnitOfWork unitOfWork) :
        IQueryHandler<GetBlogCommentQuery, PagedList<BlogCommentResult>>
    {
        ...
        {
            IQueryable<BlogComment> entities = _blogCommentRepository.Search(query.PaginationParameters);
