...
(function($) {
    ...
    ******************************************** */
    ...
    $(".active-slider-1").slick({
        ...
        slidesToShow: 1,
        slidesToScroll: 1,
        prevArrow: '<button type="button" class="arrow-prev"><i class="zmdi zmdi-long-arrow-right"></i></button>',
        nextArrow: '<button type="button" class="arrow-next"><i class="zmdi zmdi-long-arrow-left"></i></button>',
    });
        ...
        $this.countdown(finalDate,
            function(event) {
                $this.html(event.strftime(
                    '<span class="cdown days"><span class="time-count">%-D</span> <p>روز</p></span> <span class="cdown hour"><span class="time-count">%-H</span> <p>ساعت</p></span> <span class="cdown minutes"><span class="time-count">%M</span> <p>دقیقه</p></span> <span class="cdown second"> <span><span class="time-count">%S</span> <p>ثانیه</p></span>'));
            });
    });
