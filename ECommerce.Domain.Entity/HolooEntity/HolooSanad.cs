...
public class HolooSanad
{
    public HolooSanad(string comment)
    {
        ...
        Sanad_Time = new DateTime(1900, 1, 1, DateTime.Now.ToLocalTime().Hour, DateTime.Now.ToLocalTime().Minute,
    ...
    public int? Sanad_Code_C2 { get; set; }
    public DateTime? Sanad_Date { get; set; }
    public DateTime? Sanad_Time { get; set; }
    public string Comment { get; set; }
    public short? Sanad_Type { get; set; }
    public string DateUser { get; set; }
    public string TimeUser { get; set; }
    public int? UserCodeInc { get; set; }
