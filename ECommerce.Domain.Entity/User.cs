...
{
    [Display(Name = "تاریخ ثبت نام")] public DateTime RegisterDate { get; set; } = DateTime.Now;
    ...
    [Display(Name = "همکار تایید شده")] public bool IsConfirmedColleague { get; set; } = false;
